...
import { BMACommunitySelectionSearch } from "./BMACommunitySelectionSearch";
import _isEmpty from "lodash/isEmpty";

export class BMACommunitySelectionModalComponent extends Component {
  constructor(props) {
    super(props);
    const {
      chosenCommunity,
    ...
    return (
      <CommunityContext.Provider value={this.contextValue}>
        ...
        >
          ...
          <BMACommunitySelectionSearch apiConfigs={apiConfigs} record={record} />
...
BMACommunitySelectionModalComponent.propTypes = {
...
export const BMACommunitySelectionModal = connect(
  mapStateToProps,
  null
)(BMACommunitySelectionModalComponent);