...
import { BMACreatibutorsIdentifiers } from "./BMACreatibutorsIdentifiers";
...
export class BMACreatibutorsModal extends Component {
  constructor(props) {
    super(props);
    this.state = {
      open: false,
...
BMACreatibutorsModal.propTypes = {
...
BMACreatibutorsModal.defaultProps = {
  roleOptions: [],
  initialCreatibutor: {},
