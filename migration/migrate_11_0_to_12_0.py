...
# IMPORTANT!!!: this is a modified copy of the
# migration file that is in:
# <venv>/lib/python3.9/site-packages/invenio_app_rdm/upgrade_scripts/migrate_11_0_to_12_0.py

# run this migration file rather than the one in the virtualenv 
# Few lines have been added, they are indicated by # added by Valeria
# Verify the file:
# <venv>/lib/python3.9/site-packages/invenio_app_rdm/upgrade_scripts/migrate_11_0_to_12_0.py
# was not futher modified after Sept 13 2023, otherwise this file needs to be updated 
...
def execute_upgrade():
    ...
    def update_parent(record):
        ...
        record.parent.pids = {} # added by Valeria
        if (
    ...
    def update_record(record):
        ...
        try:
            ...
            new_record_schema = "local://records/record-v6.0.0.json" # added by Valeria
            record["$schema"] = new_record_schema # added by Valeria
